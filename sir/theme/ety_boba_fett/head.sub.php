...
add_javascript('<script src="'.G5_URL.'/sjh/sjh.js"></script>',1);
add_javascript('<script src="'.G5_URL.'/sjh/swiperSjh.js"></script>', 2);
...
<link rel="stylesheet" href="<?php echo G5_URL; ?>/sjh/styleSjh.min.css">

</head>
<body
<?php echo isset($g5['body_script']) ? $g5['body_script'] : ''; ?>
class="<?php echo $bo_table; ?> <?php echo $co_id; ?>"
>
<?php
